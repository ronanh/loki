...
Loki uses [GitHub](https://github.com/ronanh/loki) to manage reviews of pull requests:
...
```bash
$ git clone https://github.com/ronanh/loki.git $GOPATH/src/github.com/ronanh/loki
...
Note that if you downloaded Loki using `go get`, the message `package github.com/ronanh/loki: no Go files in /go/src/github.com/ronanh/loki`
