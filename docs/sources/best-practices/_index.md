...
Loki has several client options: [Promtail](https://github.com/ronanh/loki/tree/master/docs/sources/clients/promtail) (which also supports systemd journal ingestion and TCP-based syslog ingestion), [Fluentd](https://github.com/ronanh/loki/tree/master/fluentd/fluent-plugin-grafana-loki), [Fluent Bit](https://github.com/ronanh/loki/tree/master/cmd/fluent-bit), a [Docker plugin](https://grafana.com/blog/2019/07/15/lokis-path-to-ga-docker-logging-driver-plugin-support-for-systemd/), and more!
