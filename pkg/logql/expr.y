...
%token <val>      MATCHERS LABELS EQ RE NRE OPEN_BRACE CLOSE_BRACE OPEN_BRACKET CLOSE_BRACKET COMMA DOT PIPE_MATCH PIPE_EXACT
                  ...
                  BYTES_OVER_TIME BYTES_RATE BOOL JSON REGEXP LOGFMT PATTERN PIPE LINE_FMT LABEL_FMT UNWRAP AVG_OVER_TIME SUM_OVER_TIME
                  MIN_OVER_TIME MAX_OVER_TIME STDVAR_OVER_TIME STDDEV_OVER_TIME QUANTILE_OVER_TIME
                  BYTES_CONV DURATION_CONV DURATION_SECONDS_CONV ABSENT_OVER_TIME LABEL_REPLACE UNPACK DROP
